...
//let = ogr1_yas = 2022 - ogr1_dogumTarihi;
//let = ogr1_yas = 2022 - parseInt(ogr1_dogumTarihi); // tam sayı verir
let = ogr1_yas = suankiYil - parseInt(ogr1_dogumTarihi); // tam sayı verir
let = ogr2_yas = suankiYil - parseInt(ogr2_dogumTarihi); // tam sayı verir
